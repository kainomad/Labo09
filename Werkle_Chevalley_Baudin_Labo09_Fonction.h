...
/**
 \brief Assigne les valeurs d'une colonne dans un tableau multidimentionnel
 * \param[in] tab contient un tableau de numériques entiers
 * \param[in] tabDeuxDim contient un tableau multidimentionnel[][] de numériques entiers
 * \param[in] N contient la taille du tableau
 * \param[in] val contient le numéro de colonne qui doit être affecté
 *
 * Assigne dans une colonne d'un tableau multidimentionnel[N][N] les valeurs
 * d'un 2ème tableau[N]
 */
...
/**
 \brief inverse les axes dans un tableau bidimentionnel
 * \param[in] table2Dim contient un tableau bidimentionnel [][] de numériques entiers
 * \param[in] N contient la taille du tableau
 *
 * Inverse les valeurs d'un tableau bidimentionnel en arrangeant les valeurs afin
 * d'obtenir un symétrique par rapport à la diagonale de haut gauche à bas droite.
 */
